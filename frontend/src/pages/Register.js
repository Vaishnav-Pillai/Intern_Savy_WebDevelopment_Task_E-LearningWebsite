          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                <h2 className="mt-0" style={{fontFamily: '-moz-initial', fontWeight: 'bold', fontSize: '45px'}}>Create an Account!</h2>
                    ...
                    <div>
                      <form className="user my-2">
                        ...
                        <div className='text-center my-5'>
                          <button className="btn btn-outline-light" type="submit" onClick={handleSubmit} style={{fontSize: '25px'}}>Register Account</button>
                        </div>
                        <hr/>
                        <div className='text-center my-3'>
                          <Link to="/" className="btn btn-google btn-user btn-block btn-success disabled" style={{fontSize: '20px'}}>
                            <i className="fab fa-google fa-fw"></i> Register with Google
                          </Link>
                        </div>
                        <div className='text-center my-3'>
                          <Link to="/" className="btn btn-facebook btn-user btn-block btn-primary disabled" style={{fontSize: '20px'}}>
